...
<Tabs items={["CLI (Recommended)", "Programmatic", "Background Thread", "Async"]}>
...
The default worker pool uses OS threads, which share a single Python GIL. For
