...
<Callout type="warn" title="Authentication is required out of the box">
  ...
  [Authentication](/guides/observability/dashboard-auth) for the full
...
| Configuration | **Tasks** | Decorator defaults + runtime overrides per task ([guide](/guides/observability/task-overrides)) |
...
[Dashboard REST API](/guides/observability/dashboard-api).
...
See [Authentication](/guides/observability/dashboard-auth) for the env
...
[Task & Queue Overrides](/guides/observability/task-overrides).
