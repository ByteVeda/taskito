...
**TL;DR**: Taskito is <SdkSwap python="Celery" node="BullMQ" /> without the
...
| Core language | **Rust + <SdkSwap python="Python" node="Node.js" />** | Python | Python | Python | Python | Python |
...
<SdkLink to="guides/operations">
  Migrating from <SdkSwap python="Celery" node="BullMQ" />
</SdkLink>{" "}
