...
| `"on_failure"` | At least one predecessor dead-lettered |
...
<Mermaid
  chart={`graph LR
    ...
    classDef skip fill:#fef9c3,color:#713f12,stroke:#ca8a04
    classDef run fill:#bbf7d0,color:#14532d,stroke:#16a34a
