...
still drives the Host header and TLS SNI. A resolver failure is a transient
error and is retried like any other. For user-supplied URLs, keep an egress
allowlist in front of the worker as defense in depth.
