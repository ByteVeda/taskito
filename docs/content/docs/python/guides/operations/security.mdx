...
For confidentiality as well, wrap `EncryptedSerializer`. See
[Pluggable Serializers](/docs/guides/extensibility/serializers) for the full
matrix.
...
closes the DNS-rebinding SSRF window, and redirects are not followed. For
