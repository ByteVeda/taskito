...
public final class Task<T> {
    ...
    public static <T> Task<T> of(String name, Class<T> payloadType) {
        return new Task<>(name, payloadType, EnqueueOptions.none(), null, List.of(), false);
    }
    ...
    public static <T> Task<T> of(String name, TypeReference<T> payloadType) {
        return new Task<>(name, payloadType.getType(), EnqueueOptions.none(), null, List.of(), false);
    }

    /** A copy of this task with the given default options. */
    public Task<T> withOptions(EnqueueOptions options) {
        return new Task<>(name, payloadType, options, retryPolicy, codecs, idempotent);
    }
    ...
    public Task<T> codecs(String... codecs) {
        return new Task<>(name, payloadType, options, retryPolicy, Arrays.asList(codecs), idempotent);
    }
